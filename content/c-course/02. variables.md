...
TODO: consider moving printf to previous lesson
...
Con le variabili di tipo intero, è possibile eseguire esepressioni numeriche. Possiamo usare le operazioni elementari, `+`, `-`, `*` (moltiplicazione), `/` (divisione). 
...
Possiamo usare C come una calcolatrice ora (w-wow...)!!
...
Maiuscole e minuscole sono lettere distinte.
...
Inoltre, i linguaggi di programmazione moderni seguono le stesse regole di nominazione.
