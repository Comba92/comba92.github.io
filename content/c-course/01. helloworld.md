...
https://www.iso-9899.info/wiki/Implementation
https://en.wikipedia.org/wiki/Entry_point
https://en.wikipedia.org/wiki/Crt0
https://www.cppstories.com/2017/02/how-to-stay-sane-with-modern-c/
https://nullprogram.com/blog/2014/04/25/
...
https://smarimccarthy.is/posts/2024-12-02-four-years-of-jai/#0-the-lost-era-of-good-software
...
Quando si impara un nuovo linguaggio di programmazione, si è soliti scrivere un programma di 'Hello World'. Questo è il più semplice programma che si può scrivere, che mostra su schermo solamente la frase "Hello World!", e può essere utile per capire la sintassi basilare del linguaggio.
...
Di solito però, saremo interessati a pochi e comuni flag.
...
```bash
gcc file_sorgente.c && ./a.out
```

Inoltre possiamo scegliere un nome per il file eseguibile generato con la flag `-o`
```bash
